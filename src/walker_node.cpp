 ...
 * The robot moves forward until it detects an obstacle within a certain distance.
 * When an obstacle is detected, the robot rotates in the opposite direction of the obstacle.
 * 
 * The Walker node uses the WalkerContext class to manage the state of the robot.
 * The WalkerContext class has three concrete states: MoveForward, TurnLeft, and TurnRight.
 * The MoveForward state moves the robot forward, the TurnLeft state rotates the robot left,
 * and the TurnRight state rotates the robot right.
 * 
 */
